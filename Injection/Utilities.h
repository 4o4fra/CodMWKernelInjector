...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
PVOID GetDLLFile(LPCWSTR file_path)
{
...
DWORD ThreadProcID(LPCSTR window_class_name, PDWORD p_thread_id)
{
	DWORD process_id = 0;
	while (!process_id)
	{
...
string NameByPid(DWORD process_id)
{
